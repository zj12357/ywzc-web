...
export const asyncRouterMap = [
        ...
        children: [
          {
            ...
            meta: { title: '站点列表',  keepAlive: true, hiddenHeaderContent: true, permission: [ 'application' ]}
          },
          {
            path: '/application/sigapplist',
            name: 'sigAppList',
            component: () => import('@/views/application/SigAppList'),
            meta: { title: 'APP列表',  keepAlive: true, hiddenHeaderContent: true, permission: [ 'applicationList' ]}
          },
          {
            path: '/cf',
            name: 'cfVerb',
        ...
        //权限管理
      {
        ...
        children:[
...

          {
            ...
            meta: { title: '用户管理', permission: [ 'consumer' ]},
          },
        ]
      }
  ...
  //模版分组
  {
    ...
    meta: { title: '模版分组',  keepAlive: true, permission: [ 'templateManager' ]},
    children:[
      {
        path:'/templateManager/personTemplate/group',
        name:'templateGroup',
        component: () => import('@/views/templateManager/templateGroup'),
        meta: { title: '模版分组',  keepAlive: true,  hiddenHeaderContent: true,permission: [ 'templateManager' ]},
      }
